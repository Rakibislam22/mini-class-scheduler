                        ...
                        <>
                            <section className="rounded-[1.75rem] border border-white/10 bg-slate-950/70 p-6 shadow-xl shadow-slate-950/30 backdrop-blur">
                                ...
                                <form className="mt-6 space-y-4" onSubmit={handleAddSlot}>
                                    ...
                                    <button
                                        type="submit"
                                        className="inline-flex w-full items-center justify-center rounded-2xl bg-emerald-400 px-4 py-3 font-semibold text-slate-950 transition hover:bg-emerald-300"
                                    >
                                        Add 15-minute slot
                                    </button>
                                </form>
